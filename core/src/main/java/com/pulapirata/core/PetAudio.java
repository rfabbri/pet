...
class PetAudio {
    ...
    public static Loop socialNetwork = fxSoundBoard.getLoop("pet/audio/fx/pcpet");//som temporario, alterar para o som do pingo mexendo no celular assim q disponivel
