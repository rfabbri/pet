...
public class PingoChorando {
  public static String IMAGE = "pet/sprites/pingo_bebe_chorando.png";
  public static String JSON = "pet/sprites/pingo_bebe_chorando.json";
  ...
  public PingoChorando(final GroupLayer pingoLayer, final float x, final float y) {
