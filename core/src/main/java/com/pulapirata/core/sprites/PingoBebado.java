...
public class PingoBebado {
  public static String IMAGE = "pet/sprites/pingo_bebe_bebado.png";
  public static String JSON = "pet/sprites/pingo_bebe_bebado.json";
  ...
  public PingoBebado(final GroupLayer pingoLayer, final float x, final float y) {
