...
public class PingoTriste {
  public static String IMAGE = "pet/sprites/pingo_bebe_triste.png";
  public static String JSON = "pet/sprites/pingo_bebe_triste.json";
  ...
  public PingoTriste(final GroupLayer pingoLayer, final float x, final float y) {
