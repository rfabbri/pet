...
public class PingoPiscando {
  ...
  private boolean traversed = false; // Para verificar se todos os sprites foram lidos (Nao Funcionando)
  ...
  public void update(int delta) {
    if (hasLoaded) {
     //System.out.println("spriteIndex: " + spriteIndex +  " sprite.numSprites: " + sprite.numSprites()); //Testando Numeros Sprites
